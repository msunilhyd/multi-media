#!/usr/bin/env python3
"""
Fix script to add AFCON matches to local database without duplicating fetched_dates
"""
...
async def fix_local_afcon():
    """Fix local database by adding AFCON matches"""
    ...
    try:
        ...
        # Process next 7 days
        for i in range(1, 8):  # Skip today, start from tomorrow
