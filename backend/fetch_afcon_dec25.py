...
async def fetch_afcon_december_25():
    """Fetch AFCON matches specifically for December 25, 2025"""
    ...
    try:
        ...
        print(f'🔍 Fetching AFCON matches for {target_date}...')
        
        # Fetch matches for December 25, 2025
        ...
        print(f'📊 Total AFCON matches found: {len(afcon_matches)}')
        ...
        print(f'\n🎉 AFCON December 25 Fetch Complete!')
...
if __name__ == "__main__":
    ...
    asyncio.run(fetch_afcon_december_25())