    ...
    <header className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white shadow-lg border-b border-gray-700 sticky top-0 z-[100] pointer-events-auto">
      <div className="container mx-auto px-2 sm:px-4 py-2 sm:py-4">
        ...
        <div className="flex items-center justify-between gap-2 mb-2 sm:mb-0">
          ...
          <div className="flex items-center gap-1 sm:gap-4 pointer-events-auto">
            {status === 'loading' ? (
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-1 sm:py-2 bg-gray-800/80 hover:bg-gray-700 text-gray-200 border border-gray-600 hover:border-blue-500/50 rounded-xl transition-all text-xs sm:text-sm"
                >
                  {session.user?.image ? (
                    <img 
