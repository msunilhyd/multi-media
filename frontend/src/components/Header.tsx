    ...
    <header className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white shadow-lg border-b border-gray-700 sticky top-0 z-[100] pointer-events-auto">
      <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
        <div className="flex items-center justify-between flex-wrap gap-2 sm:gap-4">
          {/* Logo / Home */}
          <Link href="/" className="group flex items-center gap-2 sm:gap-3 hover:opacity-90 transition-all pointer-events-auto min-w-0">
          ...
          {/* Navigation Links */}
          <nav className="flex items-center gap-1 sm:gap-4 flex-wrap justify-center flex-1 sm:flex-none pointer-events-auto">
            <Link
              href="/football"
              className={`group relative flex items-center gap-1 sm:gap-3 px-1.5 sm:px-6 py-2 sm:py-3 rounded-2xl transition-all duration-300 font-medium cursor-pointer pointer-events-auto text-xs sm:text-sm ${
                isActive('/football')
                  ? 'bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 text-white shadow-xl shadow-blue-500/40 scale-100 sm:scale-105'
            ...
            >
              ...
              <div className="flex-col items-start pointer-events-none hidden sm:flex">
                <span className="text-xs sm:text-sm font-bold tracking-wide">Football</span>
            ...
            <Link
              ...
              className={`group relative flex items-center gap-1 sm:gap-3 px-1.5 sm:px-6 py-2 sm:py-3 rounded-2xl transition-all duration-300 font-medium cursor-pointer pointer-events-auto text-xs sm:text-sm ${
                isActive('/music')
                  ? 'bg-gradient-to-r from-purple-600 via-pink-500 to-rose-500 text-white shadow-xl shadow-purple-500/40 scale-100 sm:scale-105'
            ...
            >
              ...
              <div className="flex-col items-start pointer-events-none hidden sm:flex">
                <span className="text-xs sm:text-sm font-bold tracking-wide">Music</span>
            ...
            <Link
              ...
              className={`group relative flex items-center gap-1 sm:gap-3 px-1.5 sm:px-6 py-2 sm:py-3 rounded-2xl transition-all duration-300 font-medium cursor-pointer pointer-events-auto text-xs sm:text-sm ${
                isActive('/fun')
                  ? 'bg-gradient-to-r from-green-600 via-emerald-500 to-teal-500 text-white shadow-xl shadow-green-500/40 scale-100 sm:scale-105'
            ...
            >
              ...
              <div className="flex-col items-start pointer-events-none hidden sm:flex">
                <span className="text-xs sm:text-sm font-bold tracking-wide">Fun</span>
            ...
            <Link
              ...
              className={`group relative flex items-center gap-1 sm:gap-3 px-1.5 sm:px-6 py-2 sm:py-3 rounded-2xl transition-all duration-300 font-medium cursor-pointer pointer-events-auto text-xs sm:text-sm ${
                isActive('/contact')
                  ? 'bg-gradient-to-r from-orange-600 via-red-500 to-pink-500 text-white shadow-xl shadow-orange-500/40 scale-100 sm:scale-105'
            ...
            >
              ...
              <div className="flex-col items-start pointer-events-none hidden sm:flex">
                <span className="text-xs sm:text-sm font-bold tracking-wide">Contact</span>
                <span className={`text-xs ${isActive('/contact') ? 'text-orange-100' : 'text-gray-400'}`}>Feedback</span>
              </div>
              {isActive('/contact') && (
                <span className="absolute top-1 right-2 w-2 h-2 bg-green-400 rounded-full animate-pulse pointer-events-none"></span>
              )}
            ...
            {/* User Authentication */}
            <div className="flex items-center gap-2 sm:gap-4 pointer-events-auto flex-wrap justify-center">
              {status === 'loading' ? (
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-2 bg-gray-800/80 hover:bg-gray-700 text-gray-200 border border-gray-600 hover:border-blue-500/50 rounded-xl transition-all text-xs sm:text-sm"
                  >
                    {session.user?.image ? (
                      <img 
                ...
                <div className="flex items-center gap-1 sm:gap-3 flex-wrap justify-center">
                  <button
                    ...
                    className="px-2 sm:px-4 py-1 sm:py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all font-medium shadow-lg text-xs sm:text-sm"
                  >
                    Sign In
                  </button>
                  <button
